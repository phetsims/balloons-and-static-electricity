...
const twoBalloonExperimentLabelString = BalloonsAndStaticElectricityFluent.a11y.twoBalloonExperimentLabelStringProperty.value;
const chargeSettingsLabelString = BalloonsAndStaticElectricityFluent.a11y.chargeSettingsLabelStringProperty.value;
const chargeSettingsDescriptionString = BalloonsAndStaticElectricityFluent.a11y.chargeSettingsDescriptionStringProperty.value;
const showAllChargesAlertString = BalloonsAndStaticElectricityFluent.a11y.showAllChargesAlertStringProperty.value;
const shoNoChargesAlertString = BalloonsAndStaticElectricityFluent.a11y.shoNoChargesAlertStringProperty.value;
const showChargeDifferencesAlertString = BalloonsAndStaticElectricityFluent.a11y.showChargeDifferencesAlertStringProperty.value;
const removeWallDescriptionString = BalloonsAndStaticElectricityFluent.a11y.removeWallDescriptionStringProperty.value;
const twoBalloonExperimentDescriptionString = BalloonsAndStaticElectricityFluent.a11y.twoBalloonExperimentDescriptionStringProperty.value;
const resetBalloonsAlertPatternString = BalloonsAndStaticElectricityFluent.a11y.resetBalloonsAlertPatternStringProperty.value;
const balloonString = BalloonsAndStaticElectricityFluent.a11y.balloonStringProperty.value;
const balloonsString = BalloonsAndStaticElectricityFluent.a11y.balloonsStringProperty.value;
const wallAddedString = BalloonsAndStaticElectricityFluent.a11y.wallAddedStringProperty.value;
const wallRemovedString = BalloonsAndStaticElectricityFluent.a11y.wallRemovedStringProperty.value;
const positionsString = BalloonsAndStaticElectricityFluent.a11y.positionsStringProperty.value;
const positionString = BalloonsAndStaticElectricityFluent.a11y.positionStringProperty.value;
const balloonSettingsLabelString = BalloonsAndStaticElectricityFluent.a11y.balloonSettingsLabelStringProperty.value;
const resetBalloonsDescriptionPatternString = BalloonsAndStaticElectricityFluent.a11y.resetBalloonsDescriptionPatternStringProperty.value;
