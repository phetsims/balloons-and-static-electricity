...
const atWallString = BalloonsAndStaticElectricityFluent.a11y.atWallStringProperty.value;
const balloonStickingToString = BalloonsAndStaticElectricityFluent.a11y.balloonStickingToStringProperty.value;
const balloonOnString = BalloonsAndStaticElectricityFluent.a11y.balloonOnStringProperty.value;
const balloonAtString = BalloonsAndStaticElectricityFluent.a11y.balloonAtStringProperty.value;
const balloonPositionAttractiveStatePatternString = BalloonsAndStaticElectricityFluent.a11y.balloonPositionAttractiveStatePatternStringProperty.value;
const initialMovementPatternString = BalloonsAndStaticElectricityFluent.a11y.initialMovementPatternStringProperty.value;
const continuousMovementWithLabelPatternString = BalloonsAndStaticElectricityFluent.a11y.continuousMovementWithLabelPatternStringProperty.value;
const twoBalloonInitialMovementPatternString = BalloonsAndStaticElectricityFluent.a11y.twoBalloonInitialMovementPatternStringProperty.value;
const twoBalloonNoChangeAndPositionPatternString = BalloonsAndStaticElectricityFluent.a11y.twoBalloonNoChangeAndPositionPatternStringProperty.value;
const twoBalloonNowDirectionPatternString = BalloonsAndStaticElectricityFluent.a11y.twoBalloonNowDirectionPatternStringProperty.value;
const extremelySlowlyString = BalloonsAndStaticElectricityFluent.a11y.extremelySlowlyStringProperty.value;
const verySlowlyString = BalloonsAndStaticElectricityFluent.a11y.verySlowlyStringProperty.value;
const slowlyString = BalloonsAndStaticElectricityFluent.a11y.slowlyStringProperty.value;
const quicklyString = BalloonsAndStaticElectricityFluent.a11y.quicklyStringProperty.value;
const veryQuicklyString = BalloonsAndStaticElectricityFluent.a11y.veryQuicklyStringProperty.value;
const upDraggingString = BalloonsAndStaticElectricityFluent.a11y.upDraggingStringProperty.value;
const leftDraggingString = BalloonsAndStaticElectricityFluent.a11y.leftDraggingStringProperty.value;
const downDraggingString = BalloonsAndStaticElectricityFluent.a11y.downDraggingStringProperty.value;
const rightDraggingString = BalloonsAndStaticElectricityFluent.a11y.rightDraggingStringProperty.value;
const upAndToTheRightDraggingString = BalloonsAndStaticElectricityFluent.a11y.upAndToTheRightDraggingStringProperty.value;
const upAndToTheLeftDraggingString = BalloonsAndStaticElectricityFluent.a11y.upAndToTheLeftDraggingStringProperty.value;
const downAndToTheRightDraggingString = BalloonsAndStaticElectricityFluent.a11y.downAndToTheRightDraggingStringProperty.value;
const downAndToTheLeftDraggingString = BalloonsAndStaticElectricityFluent.a11y.downAndToTheLeftDraggingStringProperty.value;
...
const atLeftEdgeString = BalloonsAndStaticElectricityFluent.a11y.atLeftEdgeStringProperty.value;
const atTopString = BalloonsAndStaticElectricityFluent.a11y.atTopStringProperty.value;
const atBottomString = BalloonsAndStaticElectricityFluent.a11y.atBottomStringProperty.value;
const atRightEdgeString = BalloonsAndStaticElectricityFluent.a11y.atRightEdgeStringProperty.value;
const onSweaterString = BalloonsAndStaticElectricityFluent.a11y.onSweaterStringProperty.value;
const offSweaterString = BalloonsAndStaticElectricityFluent.a11y.offSweaterStringProperty.value;
const closerToObjectPatternString = BalloonsAndStaticElectricityFluent.a11y.closerToObjectPatternStringProperty.value;
const sweaterString = BalloonsAndStaticElectricityFluent.a11y.sweaterStringProperty.value;
...
const topEdgeOfPlayAreaString = BalloonsAndStaticElectricityFluent.a11y.topEdgeOfPlayAreaStringProperty.value;
const bottomEdgeOfPlayAreaString = BalloonsAndStaticElectricityFluent.a11y.bottomEdgeOfPlayAreaStringProperty.value;
const noChangeAndPositionPatternString = BalloonsAndStaticElectricityFluent.a11y.noChangeAndPositionPatternStringProperty.value;
const nearSweaterString = BalloonsAndStaticElectricityFluent.a11y.nearSweaterStringProperty.value;
const balloonNearString = BalloonsAndStaticElectricityFluent.a11y.balloonNearStringProperty.value;
const positionAndInducedChargePatternString = BalloonsAndStaticElectricityFluent.a11y.positionAndInducedChargePatternStringProperty.value;
const singleStatementPatternString = BalloonsAndStaticElectricityFluent.a11y.singleStatementPatternStringProperty.value;
const keyboardInteractionCueString = BalloonsAndStaticElectricityFluent.a11y.keyboardInteractionCueStringProperty.value;
const touchInteractionCueString = BalloonsAndStaticElectricityFluent.a11y.touchInteractionCueStringProperty.value;
const balloonLabelWithAttractiveStatePatternString = BalloonsAndStaticElectricityFluent.a11y.balloonLabelWithAttractiveStatePatternStringProperty.value;
const balloonVeryCloseToString = BalloonsAndStaticElectricityFluent.a11y.balloonVeryCloseToStringProperty.value;
const continuousMovementPatternString = BalloonsAndStaticElectricityFluent.a11y.continuousMovementPatternStringProperty.value;
const continuousMovementWithLandmarkPatternString = BalloonsAndStaticElectricityFluent.a11y.continuousMovementWithLandmarkPatternStringProperty.value;
const nowDirectionPatternString = BalloonsAndStaticElectricityFluent.a11y.nowDirectionPatternStringProperty.value;
const balloonPositionNoChangePatternString = BalloonsAndStaticElectricityFluent.a11y.balloonPositionNoChangePatternStringProperty.value;
const noChangeWithInducedChargePatternString = BalloonsAndStaticElectricityFluent.a11y.noChangeWithInducedChargePatternStringProperty.value;
const balloonPositionNearOtherPatternString = BalloonsAndStaticElectricityFluent.a11y.balloonPositionNearOtherPatternStringProperty.value;
const grabbedNonePatternString = BalloonsAndStaticElectricityFluent.a11y.grabbedNonePatternStringProperty.value;
const grabbedChargePatternString = BalloonsAndStaticElectricityFluent.a11y.grabbedChargePatternStringProperty.value;
const grabbedWithOtherChargePatternString = BalloonsAndStaticElectricityFluent.a11y.grabbedWithOtherChargePatternStringProperty.value;
const grabbedWithHelpPatternString = BalloonsAndStaticElectricityFluent.a11y.grabbedWithHelpPatternStringProperty.value;
...
export default class BalloonPositionDescriber {
  ...
  // Wall model used when describing wall visibility, proximity, and induced charge.
  private readonly wall: WallModel;

  // Balloon whose position descriptions are generated by this describer.
  private readonly balloonModel: BalloonModel;

  // Parent describer used to compose position descriptions with charge and rubbing descriptions.
  private readonly balloonDescriber: BalloonDescriber;

  // Accessible name for this balloon, such as "yellow balloon" or "green balloon".
  private readonly accessibleName: string;

  // Accessible name for the other balloon, used in two-balloon position descriptions.
  private readonly otherAccessibleName: string;

  /**
   * @param balloonDescriber - manages all balloon descriptions
   * @param model
   * @param balloonModel
   * @param accessibleName - accessible name for this balloon being described
   * @param otherAccessibleName - reference to the other balloon being described
   */
  public constructor( balloonDescriber: BalloonDescriber, model: BASEModel, balloonModel: BalloonModel, accessibleName: string, otherAccessibleName: string ) {
   ...
   */
  private getAttractiveStateOrProximityDescription(): string {
    let string = '';
   ...
   */
  public getAttractiveStateAndPositionDescription(): string {
   ...
   */
  public getAttractiveStateAndPositionDescriptionWithLabel(): string {
   ...
   */
  public getOnPositionDescription(): string {
   ...
   */
  public getBalloonPositionDescription(): string {
   ...
   */
  private getPositionDescriptionWithoutOverlap(): string {
   ...
   */
  private getDescribedPoint(): Vector2 {
   ...
   * "Off sweater"
   */
  public getOnSweaterString( onSweater: boolean ): string {
    let description;
   ...
   */
  public getLandmarkDragDescription(): string | null {
    ...
    let alert: string | null = this.getAttractiveStateAndPositionDescription();
   ...
   * "Closer to sweater."
   */
  public getKeyboardMovementAlert(): string {
    let alert;
   ...
   */
  public getInitialReleaseDescription(): string {
   ...
   */
  public getContinuousReleaseDescription(): string {
    let description;
    const directionString = this.getReleaseDirectionDescription( this.balloonModel.directionProperty.get()! );
   ...
   */
  public getNoChangeReleaseDescription(): string {
    let description;
   ...
   * being dragged.
   */
  public getReleaseDirectionDescription( direction: string ): string {
    const movementString = BALLOON_DIRECTION_RELEASE_MAP[ direction as keyof typeof BALLOON_DIRECTION_RELEASE_MAP ];
   ...
   * "Now Left."
   */
  public getDirectionChangedDescription(): string {
    let description;
   ...
   */
  public getMovementStopsDescription(): string {
   ...
   */
  public getJumpingDescription( center: Vector2 ): string {
    let description = '';
