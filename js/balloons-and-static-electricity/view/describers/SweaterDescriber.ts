...
// strings
const sweaterPositionString = BalloonsAndStaticElectricityFluent.a11y.sweaterPositionStringProperty.value;
...
const allString = BalloonsAndStaticElectricityFluent.a11y.allStringProperty.value;
const positiveString = BalloonsAndStaticElectricityFluent.a11y.positiveStringProperty.value;
const sweaterDescriptionPatternString = BalloonsAndStaticElectricityFluent.a11y.sweaterDescriptionPatternStringProperty.value;
const sweaterRelativeChargeAllPatternString = BalloonsAndStaticElectricityFluent.a11y.sweaterRelativeChargeAllPatternStringProperty.value;
const sweaterRelativeChargeDifferencesPatternString = BalloonsAndStaticElectricityFluent.a11y.sweaterRelativeChargeDifferencesPatternStringProperty.value;
const sweaterNoMoreChargesString = BalloonsAndStaticElectricityFluent.a11y.sweaterNoMoreChargesStringProperty.value;
const sweaterNetChargePatternString = BalloonsAndStaticElectricityFluent.a11y.sweaterNetChargePatternStringProperty.value;
const sweaterChargePatternString = BalloonsAndStaticElectricityFluent.a11y.sweaterChargePatternStringProperty.value;
const showingNoChargesString = BalloonsAndStaticElectricityFluent.a11y.showingNoChargesStringProperty.value;
const sweaterHasRelativeChargePatternString = BalloonsAndStaticElectricityFluent.a11y.sweaterHasRelativeChargePatternStringProperty.value;
const sweaterHasNetChargeShowingPatternString = BalloonsAndStaticElectricityFluent.a11y.sweaterHasNetChargeShowingPatternStringProperty.value;
const moreChargesPatternString = BalloonsAndStaticElectricityFluent.a11y.moreChargesPatternStringProperty.value;
const moreChargesFurtherPatternString = BalloonsAndStaticElectricityFluent.a11y.moreChargesFurtherPatternStringProperty.value;
const morePairsOfChargesString = BalloonsAndStaticElectricityFluent.a11y.morePairsOfChargesStringProperty.value;
const sweaterLabelString = BalloonsAndStaticElectricityFluent.a11y.sweaterLabelStringProperty.value;
const moreHiddenPairsOfChargesString = BalloonsAndStaticElectricityFluent.a11y.moreHiddenPairsOfChargesStringProperty.value;
const positiveNetChargeString = BalloonsAndStaticElectricityFluent.a11y.positiveNetChargeStringProperty.value;
const neutralNetChargeString = BalloonsAndStaticElectricityFluent.a11y.neutralNetChargeStringProperty.value;
...
const sweaterRelativeChargePatternString = BalloonsAndStaticElectricityFluent.a11y.sweaterRelativeChargePatternStringProperty.value;
...
const sweaterShowingPatternString = BalloonsAndStaticElectricityFluent.a11y.sweaterShowingPatternStringProperty.value;
const showingAllPositiveChargesString = BalloonsAndStaticElectricityFluent.a11y.showingAllPositiveChargesStringProperty.value;
