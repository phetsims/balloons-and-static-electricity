...
define( function( require ) {
  ...
  var LANDMARK_RANGES = {
    AT_LEFT_EDGE: new Range( X_LOCATIONS.AT_LEFT_EDGE - HALF_LANDMARK_WIDTH, X_LOCATIONS.AT_LEFT_EDGE + HALF_LANDMARK_WIDTH ),
    ...
    AT_WALL: new Range( X_LOCATIONS.AT_WALL - HALF_LANDMARK_WIDTH, X_LOCATIONS.AT_WALL + HALF_LANDMARK_WIDTH ),
    ...
    AT_RIGHT_EDGE: new Range( X_LOCATIONS.AT_RIGHT_EDGE - HALF_LANDMARK_WIDTH, X_LOCATIONS.AT_RIGHT_EDGE + HALF_LANDMARK_WIDTH )
  };
  ...
  X_LOCATIONS.AT_VERY_CLOSE_TO_SWEATER = LANDMARK_RANGES.AT_VERY_CLOSE_TO_SWEATER.getCenter();
